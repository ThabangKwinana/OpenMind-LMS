<%@ Page Title="" Language="C#" MasterPageFile="~/OpenMind.Master" AutoEventWireup="true" CodeBehind="PhysicsMarksManagement.aspx.cs" Inherits="OpenMind.PhysicsMarksManagement" %>
         ...
         <div class="col-md-12">
                 <div class="card">
                     <div class="card-body">
                         ...
                         <div class="row">
                             <div class="col">
                                 <asp:GridView class="table table-striped table-bordered" ID="physicsMarksGd" runat="server"></asp:GridView>
                             </div>
                         </div>
