...
namespace OpenMind
{
    public partial class PhysicsMarksManagement : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("updatePhysicsPage.aspx");
        }
        ...
        protected void displayBtn_Click(object sender, EventArgs e)
        {
            try
            {
                string sql = $"SELECT * FROM PhysicsGBTb";
                display(sql);
            }
        ...
        protected void searchBtn_Click(object sender, EventArgs e)
        {
            try
            {
                string sql = $"SELECT * FROM PhysicsGBTb WHERE Learner_ID LIKE '%{learnerID.Text.Trim()}%'";
                display(sql);
            }
            catch (SqlException ex)
            {
        ...
        public void loadAll()
        {
            try
            {
                ...
                physicsMarksGd.DataSource = ds;
                physicsMarksGd.DataBind();
