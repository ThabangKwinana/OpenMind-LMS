...
namespace OpenMind
{
    public partial class PhysicsReportPage : System.Web.UI.Page
    {
                ...
                if (reportType == "Test")
                {
                    if (filterTy == "Highest to Lowest")
                    {
                        if (num == 1)
                        {
                            try
                            {
                                string sql = $"SELECT Learner_ID, Test1_Mark FROM PhysicsGbTb ORDER BY Test1_Mark DESC";
                        ...
                        if (num == 2)
                        {
                            try
                            {
                                string sql = $"SELECT Learner_ID, Test2_Mark FROM PhysicsGbTb ORDER BY Test2_Mark DESC";
                        ...
                        if (num == 3)
                        {
                            try
                            {
                                string sql = $"SELECT Learner_ID, Test3_Mark FROM PhysicsGbTb ORDER BY Test3_Mark DESC";
                    ...
                    if (filterTy == "Average")
                    {
                        if (num == 1)
                        {
                            try
                            {
                                string sql = $"SELECT AVG(Test1_Mark) FROM PhysicsGbTB";
                        ...
                        if (num == 2)
                        {
                            try
                            {
                                string sql = $"SELECT AVG(Test2_Mark) FROM PhysicsGbTB";
                        ...
                        if (num == 3)
                        {
                            try
                            {
                                string sql = $"SELECT AVG(Test3_Mark) FROM PhysicsGbTB";
                ...
                if (reportType == "Assignment")
                {
                    if (filterTy == "Highest to Lowest")
                    {
                        if (num == 1)
                        {
                            try
                            {
                                string sql = $"SELECT Learner_ID, Ass1_Mark FROM PhysicsGbTb ORDER BY Ass1_Mark DESC";
                        ...
                        if (num == 2)
                        {
                            try
                            {
                                string sql = $"SELECT Learner_ID, Ass2_Mark FROM PhysicsGbTb ORDER BY Ass2_Mark DESC";
                        ...
                        if (num == 3)
                        {
                            try
                            {
                                string sql = $"SELECT Learner_ID, Ass3_Mark FROM PhysicsGbTb ORDER BY Ass3_Mark DESC";
                    ...
                    if (filterTy == "Average")
                    {
                        if (num == 1)
                        {
                            try
                            {
                                string sql = $"SELECT AVG(Ass1_Mark) FROM PhysicsGbTB";
                        ...
                        if (num == 2)
                        {
                            try
                            {
                                string sql = $"SELECT AVG(Ass2_Mark) FROM PhysicsGbTB";
                        ...
                        if (num == 3)
                        {
                            try
                            {
                                string sql = $"SELECT AVG(Ass3_Mark) FROM PhysicsGbTB";
