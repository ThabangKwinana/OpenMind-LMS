<%@ Page Title="" Language="C#" MasterPageFile="~/OpenMind.Master" AutoEventWireup="true" CodeBehind="MathsReportPage.aspx.cs" Inherits="OpenMind.MathsReportPage" %>
                ...
                <div class="card">
                     <div class="card-body">
                         ...
                         <div class="row">
                             <div class="col">
                                 <center>
                                    <h3>Maths Term 1(17-Jan to 25-March) Report Criteria</h3>
                                 </center>
                              ...
                              <div class="col-md-6">
                               <label>Report Type</label>
                                 <div class="form-group">
                                     <asp:RadioButton ID="rbTest" runat="server" Text="Test" GroupName="rbType" OnCheckedChanged="rbTest_CheckedChanged" />
                                      <br />
                                     <asp:RadioButton ID="rbAssignment" runat="server" Text="Assignment" GroupName="rbType" OnCheckedChanged="rbTest_CheckedChanged" />
                                 </div>
                             </div>
                         </div>
